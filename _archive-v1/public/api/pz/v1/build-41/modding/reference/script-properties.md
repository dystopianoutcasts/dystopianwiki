...
excerpt: This reference documents all properties available in PZ script files (`.txt` files in `media/scripts/`). Scripts define items, recipes, vehicles, and other game content. media/scripts/ ├── items.txt ...
game: pz
version: build-41
section: modding
category: reference
