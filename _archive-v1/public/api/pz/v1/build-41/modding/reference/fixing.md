...
excerpt: Fixing scripts define repair recipes for items, allowing players to restore durability to damaged weapons, tools, and equipment. Fixing scripts are located in `media/scripts/fixing.txt`. module Base...
game: pz
version: build-41
section: modding
category: reference
