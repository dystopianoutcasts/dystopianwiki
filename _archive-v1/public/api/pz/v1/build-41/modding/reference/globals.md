...
excerpt: Global functions are available everywhere in PZ Lua. They provide access to core game systems without needing to import anything. Returns the local player object (singleplayer or your character in...
game: pz
version: build-41
section: modding
category: reference
...
- [Script Properties](/build-41/modding/reference/script-properties) - Item/recipe propertiesbuild-41
