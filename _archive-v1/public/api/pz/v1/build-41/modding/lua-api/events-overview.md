...
excerpt: Project Zomboid uses an **event-driven architecture** where game systems broadcast events that mods can hook into. The `Events` table contains **~150 unique events** that fire during gameplay, UI...
game: pz
version: build-41
section: modding
category: lua-api
...
- [Events Reference](/build-41/modding/reference/events) - Complete event listbuild-41
