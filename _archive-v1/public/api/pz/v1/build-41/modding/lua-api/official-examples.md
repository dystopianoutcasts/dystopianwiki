...
excerpt: The Indie Stone provides official Lua examples in `media/luaexamples/`. These demonstrate core modding patterns and serve as learning resources. media/luaexamples/ ├── ISTimer.lua           # Timer...
game: pz
version: build-41
section: modding
category: lua-api
