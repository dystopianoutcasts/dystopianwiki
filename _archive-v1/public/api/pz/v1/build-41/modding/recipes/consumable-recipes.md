---
id: consumable-recipes
slug: consumable-recipes
title: Consumable vs Reusable Items in Recipes
excerpt: In Project Zomboid recipes, input items can either be consumed (destroyed) or kept (reusable). Understanding this distinction is critical for creating balanced and functional recipes. recipe Example...
game: pz
version: build-41
section: modding
category: recipes
