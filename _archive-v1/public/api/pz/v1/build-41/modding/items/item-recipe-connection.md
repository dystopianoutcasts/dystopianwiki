---
id: item-recipe-connection
slug: item-recipe-connection
title: Connecting Items and Recipes
excerpt: Custom items become useful when players can craft them. This guide shows how to create recipes that produce your custom items and use them as ingredients. module Base { item EnergyBar { Type = Food,...
game: pz
version: build-41
section: modding
category: items
