---
id: vanilla-item-anatomy
slug: vanilla-item-anatomy
title: Vanilla Item Anatomy - Complete Property Reference
excerpt: This document provides a comprehensive reference of all properties available for Project Zomboid items, based on vanilla game items. module ModuleName { imports { Base } item ItemName { // CORE...
game: pz
version: build-41
section: modding
category: items
