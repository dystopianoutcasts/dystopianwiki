...
id: vanilla-items
slug: vanilla-items
title: Vanilla Items Reference (items.txt)
excerpt: Complete reference for all **92 items** defined in `items.txt`. | Item | Weight | Description | |------|--------|-------------| | Antidepressants | 0.2 | `Base.PillsAntiDep` | | Battery | 0.1 |...
game: pz
version: build-41
section: modding
...
Complete reference for all **92 items** defined in `items.txt`.
