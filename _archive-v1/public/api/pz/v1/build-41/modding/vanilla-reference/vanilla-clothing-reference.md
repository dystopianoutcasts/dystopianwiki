...
excerpt: Complete reference for all **776 vanilla clothing items** in Project Zomboid Build 41. | Property | Description | |----------|-------------| | `BodyLocation` | Where the item is worn | | `Insulation`...
game: pz
version: build-41
section: modding
