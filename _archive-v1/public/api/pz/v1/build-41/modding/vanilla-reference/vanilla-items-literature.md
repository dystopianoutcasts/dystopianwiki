...
title: Vanilla Items Reference (items_literature.txt)
excerpt: Complete reference for all **103 items** defined in `items_literature.txt`. | Item | Weight | Description | |------|--------|-------------| | Angler USA Magazine Vol. 1 | 0.1 | `Base.FishingMag1` | |...
game: pz
version: build-41
section: modding
...
Complete reference for all **103 items** defined in `items_literature.txt`.
