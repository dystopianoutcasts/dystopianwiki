...
title: Vanilla Items Reference (farming.txt)
excerpt: Complete reference for all **39 items** defined in `farming.txt`. | Item | Weight | Description | |------|--------|-------------| | Gardening Spray Can (Full) | 1.0 | `farming.GardeningSprayFull` | |...
game: pz
version: build-41
section: modding
...
Complete reference for all **39 items** defined in `farming.txt`.
