...
title: Vanilla Items Reference (items_radio.txt)
excerpt: Complete reference for all **23 items** defined in `items_radio.txt`. | Item | Weight | Description | |------|--------|-------------| | Guerilla Radio Vol. 1 | 0.1 | `Radio.RadioMag1` | | Guerilla...
game: pz
version: build-41
section: modding
...
Complete reference for all **23 items** defined in `items_radio.txt`.
