...
title: Vanilla Items Reference (newBags.txt)
excerpt: Complete reference for all **21 items** defined in `newBags.txt`. | Item | Weight | Description | |------|--------|-------------| | Doctor Bag | 1 | `Base.Bag_DoctorBag` | | Duffel Bag | 1 |...
game: pz
version: build-41
section: modding
...
Complete reference for all **21 items** defined in `newBags.txt`.
