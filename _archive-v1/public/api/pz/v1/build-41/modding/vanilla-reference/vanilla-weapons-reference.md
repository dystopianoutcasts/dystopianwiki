...
excerpt: Complete reference for all **152 vanilla weapons** in Project Zomboid Build 41. | Stat | Description | |------|-------------| | **Damage** | Min-Max damage per hit | | **Crit** | Critical hit chance...
game: pz
version: build-41
section: modding
