...
excerpt: This guide explains what each weapon property actually **does** in gameplay - not just what it's called, but how it affects combat, skills, and durability. The `Categories` property is the **most...
game: pz
version: build-41
section: modding
