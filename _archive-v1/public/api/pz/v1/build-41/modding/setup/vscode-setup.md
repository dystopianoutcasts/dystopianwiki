...
excerpt: Visual Studio Code (VS Code) is a free, lightweight code editor that's perfect for PZ modding. It handles Lua scripts, text files, and JSON with syntax highlighting, making errors easier to spot. |...
game: pz
version: build-41
section: modding
category: setup
