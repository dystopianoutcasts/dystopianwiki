...
table_of_contents:
  ...
  - text: "CanBeDoneFromFloor"
    link: "#canbedonefromfloor"
  - text: "AllowFrozenItem"
    link: "#allowfrozenitem"
  - text: "AllowRottenItem"
    link: "#allowrottenitem"
  - text: "Complete Real-World Example"
    link: "#complete-real-world-example"
  - text: "Vanilla Recipe: Saw Logs"
    link: "#vanilla-recipe-saw-logs"
  - text: "Mod Recipe: Scrap Guns Weapon Assembly"
    link: "#mod-recipe-scrap-guns-weapon-assembly"
  - text: "Parameter Priority"
    link: "#parameter-priority"
  - text: "Source Files"
    link: "#source-files"
next_steps:
