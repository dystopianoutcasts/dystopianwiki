...
table_of_contents:
  ...
  - text: "File Location"
    link: "#file-location"
  - text: "Basic Recipe Structure"
    link: "#basic-recipe-structure"
  - text: "Module Declaration"
    link: "#module-declaration"
  - text: "Minimal Recipe Example"
    link: "#minimal-recipe-example"
  - text: "Recipe Syntax Rules"
    link: "#recipe-syntax-rules"
  - text: "Critical Syntax Differences"
    link: "#critical-syntax-differences"
  - text: "Recipe Components"
    link: "#recipe-components"
  - text: "1. Input Items"
    link: "#1-input-items"
  - text: "2. Output (Result)"
    link: "#2-output-result"
  - text: "3. Essential Parameters"
    link: "#3-essential-parameters"
  - text: "Common Recipe Patterns"
    link: "#common-recipe-patterns"
  - text: "Simple Conversion"
    link: "#simple-conversion"
  - text: "Tool-Based Crafting"
    link: "#tool-based-crafting"
  ...
  - text: "Item Type Matching"
    link: "#item-type-matching"
  - text: "Source Files"
    link: "#source-files"
  - text: "Complete Example Recipe"
    link: "#complete-example-recipe"
next_steps:
  - title: "Recipes with Crafting Tables"
    path: /build-41/modding/recipes/crafting-tables
  - title: "Consumable vs Reusable Items"
    path: /build-41/modding/recipes/consumable-recipes
  - title: "Vanilla Recipe Anatomy"
    path: /build-41/modding/recipes/vanilla-recipe-anatomy
