...
table_of_contents:
  - text: "YES, You Can Change Weapon Models at Runtime"
    link: "#yes-you-can-change-weapon-models-at-runtime"
  - text: "The Three Visual Components of a Weapon"
    link: "#the-three-visual-components-of-a-weapon"
  - text: "Method 1: Changing Held Weapon Model (setWeaponSprite)"
    link: "#method-1-changing-held-weapon-model-setweaponsprite"
  - text: "VFE's Pattern"
    link: "#vfes-pattern"
  - text: "Method 2: Changing World Dropped Model (WorldStaticModel)"
    link: "#method-2-changing-world-dropped-model-worldstaticmodel"
  - text: "Method 3: Changing Inventory Icon (setTexture)"
    link: "#method-3-changing-inventory-icon-settexture"
  - text: "Complete Tier Swap Implementation"
    link: "#complete-tier-swap-implementation"
  - text: "Step 1: Create Model/Texture Assets"
    link: "#step-1-create-modeltexture-assets"
  - text: "Step 2: Register Models in Script"
    link: "#step-2-register-models-in-script"
  - text: "Step 3: Lua Model Swap Function"
    link: "#step-3-lua-model-swap-function"
  - text: "Java Research Needed"
    link: "#java-research-needed"
  - text: "Classes to Investigate"
    link: "#classes-to-investigate"
  - text: "Where to Find Java Source"
    link: "#where-to-find-java-source"
  - text: "Specific Methods to Research"
    link: "#specific-methods-to-research"
  - text: "What You DON'T Need to Research"
    link: "#what-you-dont-need-to-research"
  - text: "Summary: For Grave Index Transmogrification"
    link: "#summary-for-grave-index-transmogrification"
