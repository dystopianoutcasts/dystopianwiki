...
tags:
  ...
  - learning-path
  - graphics
excerpt: "Learn how to create and implement custom item icons for Project Zomboid mods, including technical requirements and best practices."
table_of_contents:
  - text: "Overview"
    link: "#overview"
  - text: "Icon Requirements"
    link: "#icon-requirements"
  - text: "Using Vanilla Icons"
    link: "#using-vanilla-icons"
  - text: "Creating Custom Icons"
    link: "#creating-custom-icons"
  - text: "Implementing Your Icon"
    link: "#implementing-your-icon"
  - text: "Icon Best Practices"
    link: "#icon-best-practices"
  - text: "Color Palette Tips"
    link: "#color-palette-tips"
  - text: "Multiple Icon Variations"
    link: "#multiple-icon-variations"
