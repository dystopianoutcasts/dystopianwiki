...
tags:
  ...
  - creation
  - guide
excerpt: "Items in Project Zomboid are defined in script files within your mod's directory. This guide covers the fundamentals of creating new items.   Items must be defined in  files within your mod's  d..."
table_of_contents:
  - text: "Overview"
    link: "#overview"
  - text: "File Location"
  ...
  - text: "Common Errors"
    link: "#common-errors"
  - text: "Error: Using Colons Instead of Equals"
    link: "#error-using-colons-instead-of-equals"
  - text: "Error: Missing Required Properties"
    link: "#error-missing-required-properties"
  - text: "Error: Wrong Module Reference"
    link: "#error-wrong-module-reference"
