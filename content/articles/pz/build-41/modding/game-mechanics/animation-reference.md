...
tags:
  ...
  - modding
  - api
excerpt: "This document provides a comprehensive reference of all vanilla animations available in Project Zomboid for use in mod recipes and scripts."
table_of_contents:
  - text: "Quick Reference - Most Common AnimNodes for Modding"
    link: "#quick-reference-most-common-animnodes-for-modding"
  - text: "Table of Contents"
    link: "#table-of-contents"
  - text: "Recipe AnimNode Reference"
    link: "#recipe-animnode-reference"
  - text: "Available AnimNodes for Recipes"
    link: "#available-animnodes-for-recipes"
  - text: "Found In Vanilla Files"
    link: "#found-in-vanilla-files"
  - text: "Player Action AnimNodes"
    link: "#player-action-animnodes"
  - text: "Complete Alphabetical List (All 141 AnimNodes)"
    link: "#complete-alphabetical-list-all-141-animnodes"
  - text: "Categorized Reference"
    link: "#categorized-reference"
  - text: "Crafting & Building (11 animations)"
    link: "#crafting-building-11-animations"
  - text: "Tree & Resource Gathering (17 animations)"
    link: "#tree-resource-gathering-17-animations"
  - text: "Eating & Drinking (21 animations)"
    link: "#eating-drinking-21-animations"
  - text: "Eating Animations"
    link: "#eating-animations"
  - text: "Drinking Animations"
    link: "#drinking-animations"
  - text: "Filling Container Animations"
    link: "#filling-container-animations"
  - text: "Pouring Animations"
    link: "#pouring-animations"
  - text: "Medical (13 animations)"
    link: "#medical-13-animations"
  - text: "Weapon Actions (28 animations)"
    link: "#weapon-actions-28-animations"
  - text: "Ammunition Management"
    link: "#ammunition-management"
  - text: "Loading Weapons"
    link: "#loading-weapons"
  - text: "Unloading Weapons"
    link: "#unloading-weapons"
  - text: "Racking/Chambering Weapons"
    link: "#rackingchambering-weapons"
  - text: "Item Management (14 animations)"
    link: "#item-management-14-animations"
  - text: "Attaching Items"
    link: "#attaching-items"
  - text: "Detaching Items"
    link: "#detaching-items"
  - text: "Equipment Actions"
    link: "#equipment-actions"
  - text: "Looting (4 animations)"
    link: "#looting-4-animations"
  - text: "Reading (3 animations)"
    link: "#reading-3-animations"
  - text: "Vehicle Actions (8 animations)"
    link: "#vehicle-actions-8-animations"
  - text: "Barricade & Structures (4 animations)"
    link: "#barricade-structures-4-animations"
  - text: "Clothing (10 animations)"
    link: "#clothing-10-animations"
  - text: "Miscellaneous (2 animations)"
    link: "#miscellaneous-2-animations"
  - text: "Animation File Structure"
    link: "#animation-file-structure"
  - text: "Animation File Locations"
    link: "#animation-file-locations"
  - text: "Animation Naming Convention"
    link: "#animation-naming-convention"
  - text: "Common Animation Prefixes"
    link: "#common-animation-prefixes"
  - text: "Usage Examples"
    link: "#usage-examples"
  - text: "Basic Recipe with AnimNode"
    link: "#basic-recipe-with-animnode"
  - text: "Crafting Recipe"
    link: "#crafting-recipe"
  - text: "Disassembly Recipe"
    link: "#disassembly-recipe"
  - text: "Medical Recipe"
    link: "#medical-recipe"
  - text: "Custom Woodworking Recipe"
    link: "#custom-woodworking-recipe"
  - text: "Resource Gathering Recipe"
    link: "#resource-gathering-recipe"
  - text: "Animation System Notes"
    link: "#animation-system-notes"
  - text: "Important Considerations"
    link: "#important-considerations"
  - text: "Animation Priority"
    link: "#animation-priority"
  - text: "Fallback Behavior"
    link: "#fallback-behavior"
  - text: "Key Reference Files"
    link: "#key-reference-files"
  - text: "Game Files (Read-Only Reference)"
    link: "#game-files-read-only-reference"
  - text: "Quick Reference Commands"
    link: "#quick-reference-commands"
  - text: "Additional Resources"
    link: "#additional-resources"
  - text: "Testing Animations"
    link: "#testing-animations"
  - text: "Common Issues"
    link: "#common-issues"
