...
tags:
  ...
  - modding
  - api
excerpt: "This document provides a comprehensive reference of all vanilla sounds available in Project Zomboid for use in mod recipes and scripts."
table_of_contents:
  - text: "Quick Reference - Most Common Sounds for Recipes"
    link: "#quick-reference-most-common-sounds-for-recipes"
  - text: "Table of Contents"
    link: "#table-of-contents"
  - text: "Item Sounds"
    link: "#item-sounds"
  - text: "Bag & Container Sounds"
    link: "#bag-container-sounds"
  - text: "Crafting & Tool Sounds"
    link: "#crafting-tool-sounds"
  - text: "Breaking & Destroying Sounds"
    link: "#breaking-destroying-sounds"
  - text: "Cooking & Food Sounds"
    link: "#cooking-food-sounds"
  ...
  - text: "Alarm Sounds"
    link: "#alarm-sounds"
  - text: "Misc Item Sounds"
    link: "#misc-item-sounds"
  - text: "Object Sounds"
    link: "#object-sounds"
  - text: "Door Sounds (All Types)"
    link: "#door-sounds-all-types"
  - text: "Sliding Glass Door"
    link: "#sliding-glass-door"
  - text: "Prison Metal Door"
    link: "#prison-metal-door"
  - text: "Garage Door"
    link: "#garage-door"
  - text: "Metal Door"
    link: "#metal-door"
  ...
  - text: "Wood Door"
    link: "#wood-door"
  - text: "Wood Shack Door"
    link: "#wood-shack-door"
  - text: "Wood Gate"
    link: "#wood-gate"
  - text: "General Door Sounds"
    link: "#general-door-sounds"
  - text: "Window Sounds"
    link: "#window-sounds"
  - text: "Curtain Sounds"
    link: "#curtain-sounds"
  - text: "Appliance Sounds"
    link: "#appliance-sounds"
  - text: "BBQ & Cooking"
    link: "#bbq-cooking"
  - text: "Campfire & Fireplace"
    link: "#campfire-fireplace"
  - text: "Electronics"
    link: "#electronics"
  - text: "Generator"
    link: "#generator"
  ...
  - text: "Fuel & Canister"
    link: "#fuel-canister"
  - text: "Misc Object Sounds"
    link: "#misc-object-sounds"
  - text: "Player Sounds"
    link: "#player-sounds"
  - text: "Level & Game Events"
    link: "#level-game-events"
  - text: "Eating Sounds"
    link: "#eating-sounds"
  - text: "Drinking Sounds"
    link: "#drinking-sounds"
  - text: "Movement & Foley"
    link: "#movement-foley"
  - text: "Combat"
    link: "#combat"
  ...
  - text: "Repair"
    link: "#repair"
  - text: "Farming (Player Category)"
    link: "#farming-player-category"
  - text: "Cooking (Player Category)"
    link: "#cooking-player-category"
  - text: "Logs (Player Category)"
    link: "#logs-player-category"
  - text: "Fire Starting (Player Category)"
    link: "#fire-starting-player-category"
  - text: "Map (Player Category)"
    link: "#map-player-category"
  - text: "Door Opening (Player Category)"
    link: "#door-opening-player-category"
  - text: "World Sounds"
    link: "#world-sounds"
  - text: "Ambiance"
    link: "#ambiance"
  ...
  - text: "Zombie Sounds"
    link: "#zombie-sounds"
  - text: "Zombie Movement"
    link: "#zombie-movement"
  - text: "Zombie Vocals"
    link: "#zombie-vocals"
  - text: "Zombie Combat"
    link: "#zombie-combat"
  - text: "Zombie Interactions"
    link: "#zombie-interactions"
  - text: "Zombie Events"
    link: "#zombie-events"
  - text: "UI Sounds"
    link: "#ui-sounds"
  ...
  - text: "Meta Weapons"
    link: "#meta-weapons"
  - text: "Meta Animals & Sounds"
    link: "#meta-animals-sounds"
  - text: "Meta Game Events"
    link: "#meta-game-events"
  - text: "Music Sounds"
    link: "#music-sounds"
  - text: "Music Tracks"
    link: "#music-tracks"
  ...
  - text: "Usage Examples"
    link: "#usage-examples"
  - text: "Basic Recipe with Sound"
    link: "#basic-recipe-with-sound"
  - text: "Multiple Item Recipe"
    link: "#multiple-item-recipe"
  - text: "Food Recipe with Sound"
    link: "#food-recipe-with-sound"
  - text: "Butchering Recipe"
    link: "#butchering-recipe"
  - text: "Disassembly Recipe"
    link: "#disassembly-recipe"
  - text: "Crafting Recipe with Generic Sound"
    link: "#crafting-recipe-with-generic-sound"
  - text: "Hammering Recipe"
    link: "#hammering-recipe"
  - text: "Opening Container Recipe"
    link: "#opening-container-recipe"
  ...
  - text: "Script Files (Definitions)"
    link: "#script-files-definitions"
  - text: "Audio Files (Actual Sound Data)"
    link: "#audio-files-actual-sound-data"
  - text: "FMOD Banks (Sound Engine)"
    link: "#fmod-banks-sound-engine"
