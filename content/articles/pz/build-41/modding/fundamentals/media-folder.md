...
table_of_contents:
  ...
  - text: "The Organizational Pattern"
    link: "#the-organizational-pattern"
  ...
  - text: "The UI Folder"
    link: "#the-ui-folder"
  - text: "Creating Your Mod's Media Folder"
    link: "#creating-your-mods-media-folder"
  - text: "How the Game Loads Files"
    link: "#how-the-game-loads-files"
  - text: "Important Subfolders for Beginners"
    link: "#important-subfolders-for-beginners"
  - text: "File Naming Best Practices"
    link: "#file-naming-best-practices"
  - text: "Common Beginner Mistakes"
    link: "#common-beginner-mistakes"
  - text: "Quick Reference: What Goes Where"
    link: "#quick-reference-what-goes-where"
  - text: "Key Takeaways"
    link: "#key-takeaways"
next_steps:
