  ...
  return (
    <div className="terms-page">
        <div className="terms-page__content">
          ...
          <p className="terms-page__updated">Last updated: January 19, 2026</p>
          ...
          <section>
            ...
            <p>
              ...
              affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach
          ...
          <section>
            ...
            <ul>
              <li>By email: <a href="mailto:dystopianoutcasts@gmail.com">dystopianoutcasts@gmail.com</a></li>
            </ul>
          </section>
        </div>
      </div>
